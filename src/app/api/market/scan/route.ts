...
const QUOTE_UNIVERSE = [
  ...
  "ASHOKLEY", "EICHERMOT", "HEROMOTOCO", "ABCAPITAL", "MUTHOOTFIN",
  "CHOLAFIN", "SHRIRAMFIN", "HDFCLIFE", "SBILIFE", "LTIM", "PERSISTENT",
  "COFORGE", "ZOMATO", "CIPLA", "LUPIN", "APOLLOHOSP", "ADANIPORTS",
  "SIEMENS", "HAVELLS", "BRITANNIA", "TATACONSUM", "TATASTEEL", "JSWSTEEL",
  "HINDALCO", "COALINDIA", "DLF", "VOLTAS", "TMCV", "FRACTAL", "BANKBARODA",
  "ADANIENT", "DIVISLAB", "MARICO", "COLPAL",
];

const TECH_UNIVERSE = QUOTE_UNIVERSE.slice(0, 30);
